                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card" wire:click="addItem({{$product->id}})" style="cursor: pointer" >
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-primary btn-sm" style="position: absolute;top:0;right: 0;padding:10px 15px"><i class="fas fa-cart-plus fa-2x"></i></button>
                                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-sm table-bordered table-hovered" >
                    ...
                    @empty
                        <td colspan="4"><h6 class="text-center font-weight-bold">Empty Cart</h6></td>
                        @endforelse
                    </tbody>
                </table>
            </div>
